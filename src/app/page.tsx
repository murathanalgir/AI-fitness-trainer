        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 gap-8 items-center relative lg:grid-cols-12">
            ...
            <div className="lg:col-span-7 space-y-8 relative">
              ...
              <p className="text-lg text-foreground w-2/3">
                Experience the future of fitness with our AI-powered body transformation program. 
                Get personalized workout plans and nutrition guidance tailored to your unique needs.</p>
                {/* Stats */}
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                ...
                <Link href={"/generate-program"} className="flex items-center font-mono">
                 Build Your Program <ArrowRightIcon className="ml-2 size-5" />
                 </Link>
                </Button>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -inset-4 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-0 w-16 h-16 border-l-2 border-b-2 border-border"></div>
              </div>
              {/* img */}
            <div className="relative aspect-square max-w-lg mx-auto">
              <div className="relative overflow-hidden rounded-lg bg-cyber-black">
                <Image src="/hero-ai.png" alt="Coach" width={1024} height={1024} className="size-full object-cover object-center"/>
